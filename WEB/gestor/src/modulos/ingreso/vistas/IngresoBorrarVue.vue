        ...
        <div class="card">
            <div class="contenedor_formulario">
                <div class="formulario">
                    ...
                    <div class="mb-3">
                        Account:
                        <input type="number" class="form-control campo_input" v-model="ingresos[0].fk_id_cuenta" disabled>
                    </div>
                    <div class="mb-3">
                        Income Category:
                        <input type="number" class="form-control campo_input" v-model="ingresos[0].fk_id_categoria_ingreso" disabled>
                    </div>
                    <div class="mb-3">
                        Description: 
                        <input type="text" class="form-control campo_input" v-model="ingresos[0].descripcion" disabled>
                    </div>
                    <div class="mb-3">
                        Amount: 
                        <input type="number" class="form-control campo_input" v-model="ingresos[0].monto" disabled>
                    </div>
                    <div class="mb-3">
                        Date: 
                        <input type="date" class="form-control campo_input" v-model="ingresos[0].fecha_operacion" disabled>
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-danger boton_submit" @click="borrarIngreso(ingresos[0])">Delete</button>
                    </div>
                </div>
            </div>
        </div>
