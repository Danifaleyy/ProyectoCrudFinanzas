<template>
    ...
    <section class="contenedor_section">
        <div class="contenedor_botones">
            ...
            &nbsp;
            <!--Boton para imprimir-->
            <!--<button @click.prevent="transaccionPDF" class="btn btn-sm btn-outline-primary boton_accion" v-if="transacciones.length > 0">
    ...
    <section class="contenedor_section_tabla">
        ...
        <div v-if="transacciones.length == 0" class="no-registros">
        ...
        <div v-else v-for="(transaccion, index) in transacciones" :key="index" class="bloque-transaccion">
            ...
            <div class="bloque-acciones">
                <button type="button" class="boton_accion_botonmodificar">
                    <RouterLink :to="{ path: '/transaccion/'+ transaccion.id_transaccion + '/editar'}"><i class="fa fa-pencil"></i></RouterLink>
                </button>
                <button type="button" class="boton_accion_botonborrar">
                    <RouterLink :to="{ path: '/transaccion/'+ transaccion.id_transaccion + '/borrar'}"><i class="fa fa-trash"></i></RouterLink>
                </button>
            </div>
        </div>
    </section>
