            ...
            <div class="contenedor_formulario">
                <Form class="formulario" @submit="onTodoBien">
                    ...
                    <div class="mb-3">
                        ...
                        <Field name="nombre" type="text" class="form-control campo_input" v-model="tipo_inversion.nombre"/>
...
import { ref } from 'vue';
import type { Tipo_inversionAgregar } from '../interfaces/tipo_inversion-interfaces';
import { useTipo_inversion } from '../controladores/useTipo_inversion';
const { agregarTipo_inversion, mensaje } = useTipo_inversion();
import { Tipo_inversionSchema } from '../schemas/Tipo_inversionSchema';
...
//-----------------
//Nuevo: redirigirlo a la pagina de inicio de tipo_inversion
...
let tipo_inversion = ref<Tipo_inversionAgregar>({
    nombre: '',
});

const onTodoBien = async () => {
    console.log("Formulario enviado, datos:", tipo_inversion.value);
    await agregarTipo_inversion(tipo_inversion.value);
};
</script>
