<template>
    ...
    <section class="contenedorinicio">
        <div class="botones">
            ...
            <button class="btn btn-sm btn-outline-primary" v-if="hecho_gastos.length > 0">
    ...
    <section class="ContenedorTabla">
        <table class="desingtable" id="tablaHecho_gasto">
        ...
        <tbody>
            <tr v-if="hecho_gastos.length == 0">
                <td colspan="3">Sin hecho_gasto registrados</td>
            </tr>
            <tr v-else v-for="(hecho_gasto, index) in hecho_gastos" :key="index">
                <td>{{ hecho_gasto.id_hecho_gasto }}</td>
                <td>{{ hecho_gasto.nombre }}</td>
