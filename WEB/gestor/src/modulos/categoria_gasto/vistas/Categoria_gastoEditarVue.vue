<template>
    <div class="contedenor_padre" v-if="categoria_gastos[0]">
        <div class="card">
            <div class="contenedor_formulario">
                <div class="formulario">
                    ...
                    <div class="mb-3">
                        <button class="btn btn-primary boton_submit" @click="actualizarCategoria_gasto(categoria_gastos[0])">Update</button>
                    </div>
                </div>
            </div>
        </div>
